...
uint MyRigidBody::SAT(MyRigidBody* const a_pOther)
{
	...
	//compute common subexpression with epilon
	for (int i = 0; i < 3; i++)
	{
		for (int j = 0; j < 3; j++)
		{
	...
	for (int i = 0; i < 3; i++) {
		radiusA = this->m_v3HalfWidth[0] * AbsR[0][i] + this->m_v3HalfWidth[1] * AbsR[1][i] + this->m_v3HalfWidth[2] * AbsR[2][i];
	...
	if (glm::abs(t[2] * R[1][0] - t[1] * R[2][0]) > radiusA + radiusB) return 0;
	...
	if (glm::abs(t[2] * R[1][1] - t[1] * R[2][1]) > radiusA + radiusB) return 0;
	...
	if (glm::abs(t[2] * R[1][2] - t[1] * R[2][2]) > radiusA + radiusB) return 0;
	...
	if (glm::abs(t[0] * R[2][0] - t[2] * R[0][0]) > radiusA + radiusB) return 0;
	...
	if (glm::abs(t[0] * R[2][1] - t[2] * R[0][1]) > radiusA + radiusB) return 0;
	...
	if (glm::abs(t[0] * R[2][2] - t[2] * R[0][2]) > radiusA + radiusB) return 0;
	...
	if (glm::abs(t[1] * R[0][0] - t[0] * R[1][0]) > radiusA + radiusB) return 0;
	...
	if (glm::abs(t[1] * R[0][1] - t[0] * R[1][1]) > radiusA + radiusB) return 0;
	...
	if (glm::abs(t[1] * R[0][2] - t[0] * R[1][2]) > radiusA + radiusB) return 0;
