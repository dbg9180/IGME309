...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
	...
	{
		m_bComplimentColor = !m_bComplimentColor;
	}
}
void AppClass::Display(void)
{
	...
	GLuint InvertColor = glGetUniformLocation(m_uShaderProgramID, "ShouldInvert");
	glUniform1i(InvertColor, m_bComplimentColor);
